package com.example.tongxiang.gesture;
...
import com.example.tongxiang.MapView;
...
public class MyGestureDector {
    ...
    private MapView view;//持有View用于重绘
    ...
    public MyGestureDector(Context context, MapView view, Matrix matrix, OnGestureClickListener onGestureClickListener){
